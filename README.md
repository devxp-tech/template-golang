...
[![App Status](https://argocd.diegoluisi.eti.br/api/badge?name=${{values.component_id}}-${{values.env}}&revision=true)](https://argocd.diegoluisi.eti.br/applications/${{values.component_id}}-${{values.env}})
